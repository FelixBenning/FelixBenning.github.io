...
# ╔═╡ 64da4a62-4311-432c-bc25-b670774e5ff1
using Plots: Plots, plot, plot!

# ╔═╡ f01bc6cd-29cc-484b-8625-bc613df67253
Y(x) = 2*(x>5/6) - (x<= 5/6)

# ╔═╡ 369eb8ed-6b96-419f-b766-caecdc74537e
X = 0:0.001:1

# ╔═╡ 8c5ab789-b8ed-4a05-80d1-8e3053674039
p = plot(
	X, Y.(X), 
	fillrange=zeros(length(X)), 
	fillalpha=0.05, 
	linetype=:steppost, 
	xticks=(0:1/6:1, ["$(x)/6" for x in 0:6]),
	label="Y",
	fmt=:png
)

# ╔═╡ 362257ad-edc9-4bc2-b41b-39140812afaa
Plots.savefig(p, "../images/probability/payoff.svg")
